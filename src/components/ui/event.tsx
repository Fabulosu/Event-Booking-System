...
const Event: React.FC<Props> = ({ data }) => {
    return (
        <div key={data._id} className="h-[400px] flex flex-col justify-between hover:cursor-pointer transition-transform transform hover:scale-105 hover:z-10">
            <div className="relative">
                ...
                <h3 className="text-3xl font-semibold mt-1">{data.title}</h3>
            </div>
